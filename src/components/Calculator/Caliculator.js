    ...
    return (
      <div style={{textAlign:"center"}}>
        ...
        <div>
          ...
          <OperatorBtn writing='÷' disabled={isNotInputed} onClick={() => actions.onOperatorClick('devided')} />
        </div>
        <div>
          <NumBtn n={4} onClick={() => actions.onNumClick(4)} />
          <NumBtn n={5} onClick={() => actions.onNumClick(5)} />
          <NumBtn n={6} onClick={() => actions.onNumClick(6)} />
          <OperatorBtn writing='×' disabled={isNotInputed} onClick={() => actions.onOperatorClick('times')} />
        </div>
        <div>
          <NumBtn n={7} onClick={() => actions.onNumClick(7)} />
          <NumBtn n={8} onClick={() => actions.onNumClick(8)} />
          <NumBtn n={9} onClick={() => actions.onNumClick(9)} />
          <OperatorBtn writing='+' disabled={isNotInputed} onClick={() => actions.onOperatorClick('plus')} />
        </div>
        <div>
          ...
          <OperatorBtn writing='-' disabled={isNotInputed} onClick={() => actions.onOperatorClick('minus')} />
        </div>
      </div>
    );
  }
